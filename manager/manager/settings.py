...
SECRET_KEY = 'django-insecure-z#89a^j9^viwq-w+awnvc00@4uxiwprba39-r9+w7z27dn6#cq'
...
MIDDLEWARE = [
    ...
    'manager.middleware.BearerTokenMiddleware'
]
...
EMAIL_HOST_USER = 'melo.surseine@gmail.com'
